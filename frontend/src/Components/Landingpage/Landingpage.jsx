      ...
      <section className="py-20 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-center h-48 bg-gradient-to-r from-violet-500 to-violet-600 rounded-lg">
                ...
                <button className="mt-4 w-full bg-violet-600 text-white py-2 rounded-lg hover:bg-violet-700 transition-colors">
                  Download Template
                </button>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <div className="inline-block p-4 bg-violet-600 rounded-full">
      ...
      <footer className="bg-white py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <p className="text-black">© 2024 Invoice Generator. All rights reserved.</p>
            <div className="flex space-x-6">
              <a href="#" className="text-black hover:text-indigo-400">Terms</a>
              <a href="#" className="text-black hover:text-indigo-400">Privacy</a>
              <a href="#" className="text-black hover:text-indigo-400">Contact</a>
            </div>
          </div>
        </div>
      </footer>
